...
<html>
    ...
    <br>
      ...
      <div id="stream-container" class="image-container">
        ...
        <img id="stream" src="" class="rotate180">
      </div>
    </figure>
    <br>
    <br>
            ...
            <section id="buttons">
                ...
                <div id="controls" class="control-container">
                  ...
                  <tr><td></td><td align="center"><button class="button button2" id="forward" onmouseover="fetch(document.location.origin+'/control?var=car&val=1');">/\</button></td><td></td></tr>
                  <tr><td align="center"><button class="button button2" id="turnleft" onmouseover="fetch(document.location.origin+'/control?var=car&val=2');"><</button></td><td align="center"></td><td align="center"><button class="button button2" id="turnright" onmouseover="fetch(document.location.origin+'/control?var=car&val=4');">></button></td></tr>
                  <tr><td></td><td align="center"><button class="button button2" id="backward" onmouseover="fetch(document.location.origin+'/control?var=car&val=5');">\/</button></td><td></td></tr>
                  ...
                  <tr><td></td><td align="center"><button class="button button4" id="util" onmousedown="fetch(document.location.origin+'/control?var=util&val=true');" onmouseup="fetch(document.location.origin+'/control?var=util&val=false');">util</button></td><td></td></tr>
                  </table>
                </div>
               <br>
